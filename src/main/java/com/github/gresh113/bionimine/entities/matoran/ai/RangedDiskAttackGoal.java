...
public class RangedDiskAttackGoal <T extends MatoranEntity & IRangedAttackMob> extends Goal {
	   ...
	   public boolean shouldExecute() {
	      return this.entity.getAttackTarget() == null ? false : this.isDiskInMainhand();
	   }

	   protected boolean isDiskInMainhand() {
	      return this.entity.func_233634_a_(item -> item instanceof BambooDiskItem);
	   }
	   ...
	   public boolean shouldContinueExecuting() {
	      return (this.shouldExecute() || !this.entity.getNavigator().noPath()) && this.isDiskInMainhand();
	   }
	   ...
	   public void tick() {
	      ...
	      if (livingentity != null) {
	         ...
	         if (this.entity.isHandActive()) {
	            ...
	            this.entity.setActiveHand(ProjectileHelper.getHandWith(this.entity, ItemRegistration.bamboo_disk.get()));
	         }
