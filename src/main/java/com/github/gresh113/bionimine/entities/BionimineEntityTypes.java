...
import com.github.gresh113.bionimine.entities.elemental_projectiles.IceProjectileRenderer;
...
public class BionimineEntityTypes {
	...
	public static final RegistryObject<EntityType<HusiEntity>> HUSI = ENTITY_TYPES.register("husi", () ->
	(EntityType.Builder.<HusiEntity>create(HusiEntity :: new, 
			EntityClassification.CREATURE).size(0.9f, 1.3f).build(new ResourceLocation(Bionimine.MODID, "husi").toString())));
	...
	public static final RegistryObject<EntityType<TelescopeEntity>> TELESCOPE = ENTITY_TYPES.register("telescope", () ->
	(EntityType.Builder.<TelescopeEntity>create(TelescopeEntity :: new, 
			EntityClassification.MISC).size(.75f, 1.5f).build(new ResourceLocation(Bionimine.MODID, "telescope").toString())));
	
	public static final RegistryObject<EntityType<KanokaEntity>> KANOKA = ENTITY_TYPES.register("kanoka", () ->
	(EntityType.Builder.<KanokaEntity>create(KanokaEntity :: new, 
			EntityClassification.MISC).size(1.0f, 0.0625f).build(new ResourceLocation(Bionimine.MODID, "kanoka").toString())));


	public static final RegistryObject<EntityType<ElementalProjectileEntity>> ICE_PROJECTILE = ENTITY_TYPES.register("ice_projectile", () ->
	(EntityType.Builder.<ElementalProjectileEntity>create(ElementalProjectileEntity :: new, 
			EntityClassification.MISC).size(.05f, 0.05f).build(new ResourceLocation(Bionimine.MODID, "ice_projectile").toString())));
			
	
	@SubscribeEvent
	public static void clientSetup(FMLClientSetupEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(KANOKA.get(), BambooDiskRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ICE_PROJECTILE.get(), IceProjectileRenderer::new);
