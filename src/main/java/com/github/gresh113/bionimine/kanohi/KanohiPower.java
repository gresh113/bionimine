...
public enum KanohiPower {
	...
	NOBLE_KOMAU("Noble Komau", "noble_komau", "Mind Control", true, KanohiShape.SHAPELESS, ArmorPalette.GRAY),
	NOBLE_RURU("Noble Ruru", "noble_ruru", "Night Vision", true, KanohiShape.SHAPELESS, ArmorPalette.GRAY),
