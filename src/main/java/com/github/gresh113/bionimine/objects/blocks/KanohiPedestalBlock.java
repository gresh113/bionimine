...
public class KanohiPedestalBlock extends Block {
	...
	public static final EnumProperty<Mask> MASK = BionimineBlockProperties.MASK;
	public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;

	public KanohiPedestalBlock(Properties properties) {
		super(properties);
		this.setDefaultState(this.stateContainer.getBaseState().with(MASK, Mask.NONE).with(FACING, Direction.NORTH));
	}
	...
	public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
		if (state.get(MASK) == Mask.NONE) {return BASE_SHAPE;}
		else {return MASK_SHAPE;}
