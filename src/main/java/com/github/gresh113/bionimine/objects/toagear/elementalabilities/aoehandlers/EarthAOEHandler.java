...
public class EarthAOEHandler extends AOEAttackHandler {
	...
	protected void handleParticles(World worldIn, BlockPos pos) {
		for (double i = 2; i <= 10; ++i) {
			worldIn.addParticle(new BlockParticleData(ParticleTypes.BLOCK, Blocks.DIRT.getDefaultState()), pos.getX() + .05, pos.getY() + (i / 2), pos.getZ() + .05, 0, .5, 0);
