...
import com.github.gresh113.bionimine.client.entities.models.elementalprojectiles.FireProjectileModel;
...
public class FireProjectileHandler extends ElementalProjectileHandler {
	private static EntityModel<ElementalProjectileEntity> model = new FireProjectileModel();
